...
class LeadDB(Base):
    ...
    resume_storage_type = Column(Enum(StorageType), default=StorageType.FILESYSTEM, nullable=False)
    resume_path = Column(String(512), nullable=True)  # Path or identifier based on storage type
