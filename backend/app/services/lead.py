...
from app.core.file_upload import default_file_uploader
from app.db.models import LeadDB, StorageType
from app.models.lead import LeadCreate, LeadUpdate, LeadStatus
    ...
    async def create_lead(
        ...
        if resume_file:
            try:
                ...
                file_info = await default_file_uploader.save_file(
                    file=resume_file,
                    lead_id=lead.id,
